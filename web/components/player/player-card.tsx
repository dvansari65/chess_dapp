              ...
              >
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="font-bold flex items-center gap-2">
                        {player.username}
                        {player.rating > 1900 && <Crown className="w-4 h-4 text-yellow-400" />}
                      </div>
                      <div className="text-xs text-gray-400">{player.wallet}</div>
                    </div>
                  </div>
                  {player.isPlaying && (
                ...
                <div className="grid grid-cols-2 gap-3 mb-4">
                  <div className="bg-slate-900/50 rounded-lg p-2 text-center">
                    <div className="text-lg font-bold text-emerald-400">{player.rating}</div>
                  ...
                  <div className="bg-slate-900/50 rounded-lg p-2 text-center">
                    <div className="text-lg font-bold text-yellow-400">{player.totalWon}</div>
